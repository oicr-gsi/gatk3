...
* Groups files (--group-by) into workflow run(s) (default: group by \<ROOT_SAMPLE_NAME + TISSUE_ORIGIN + TISSUE_TYPE + TISSUE_PREP + TISSUE_REGION + LIBRARY_TEMPLATE_TYPE + GROUP_ID + TARGETED_RESEQUENCING\>)
